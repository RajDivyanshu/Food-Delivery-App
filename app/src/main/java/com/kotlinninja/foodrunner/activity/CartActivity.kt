package com.kotlinninja.foodrunner.activity
...
class CartActivity : AppCompatActivity() {
    ...
    private fun setUpCartList() {
        ...
        val dbList = com.kotlinninja.foodrunner.activity.CartActivity.GetItemsFromDBAsync(
            applicationContext
        ).execute().get()
            ...
            object : JsonObjectRequest(Method.POST, PLACE_ORDER, jsonParams, Response.Listener {
                ...
                try {
                    ...
                    * Once the DB is cleared, notify the user that the order has been placed*/
                    if (success) {
                        val clearCart =
                            com.kotlinninja.foodrunner.activity.CartActivity.ClearDBAsync(
                                applicationContext,
                                resId.toString()
                            ).execute().get()
                        ...
                        * Guess, you learned something new here*/
                        ...
                        btnOk.setOnClickListener {
                            dialog.dismiss()
                            startActivity(Intent(this@CartActivity, com.kotlinninja.foodrunner.activity.DashboardActivity::class.java))
    ...
    * redundancy in the entries*/
    override fun onSupportNavigateUp(): Boolean {
        if (com.kotlinninja.foodrunner.activity.CartActivity.ClearDBAsync(
                applicationContext,
                resId.toString()
            ).execute().get()) {
            RestaurantMenuAdapter.isCartEmpty = true
